...
M.cfg = {"wwwroot":"https:\/\/moodle.nottingham.ac.uk","sesskey":"E6ZdJYjIBP","sessiontimeout":"7200","sessiontimeoutwarning":1200,"themerev":"1663777335","slasharguments":1,"theme":"nottingham_mhs","iconsystemmodule":"core\/icon_system_fontawesome","jsrev":"1663777335","admin":"admin","svgicons":true,"usertimezone":"Europe\/London","contextid":8872110,"langrev":1663777335,"templaterev":"1663777335"};var yui1ConfigFn = function(me) {if(/-skin|reset|fonts|grids|base/.test(me.name)){me.type='css';me.path=me.path.replace(/\.js/,'.css');me.path=me.path.replace(/\/yui2-skin/,'/assets/skins/sam/yui2-skin')}};
...
<table width="100%" border="0" cellspacing="0" cellpadding="3" height="250">
  <tr>
    ...
    id="nav-notification-popover-container" data-userid="311621"
    data-region="popover-region">
    <div class="popover-region-toggle nav-link icon-no-margin"
        data-region="popover-region-toggle"
        role="button"
        aria-controls="popover-region-container-637b8ff04b635637b8ff0438882"
        aria-haspopup="true"
    ...
    <div 
        id="popover-region-container-637b8ff04b635637b8ff0438882"
    ...
    <a id="message-drawer-toggle-637b8ff04e039637b8ff0438883" class="nav-link d-inline-block popover-region-toggle position-relative icon-no-margin" href="#"
            role="button">
                ...
                <div class="action-menu-trigger">
                    <div class="dropdown">
                        <a href="#" tabindex="0" class="d-inline-block  dropdown-toggle icon-no-margin" id="action-menu-toggle-1" aria-label="User menu" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" aria-controls="action-menu-1-menu">
                            ...
                            <span class="userbutton"><span class="usertext mr-1">Xiuzhiping Quan</span><span class="avatars"><span class="avatar current"><img src="https://moodle.nottingham.ac.uk/theme/image.php/nottingham_mhs/core/1663777335/u/f2" class="userpicture defaultuserpic" width="35" height="35" alt="" /></span></span></span>
                    ...
                    <div class="dropdown-divider" role="presentation"><span class="filler">&nbsp;</span></div>
                                                                <a href="https://moodle.nottingham.ac.uk/user/profile.php?id=311621" class="dropdown-item menu-action" role="menuitem" data-title="profile,moodle" tabindex="-1" aria-labelledby="actionmenuaction-2">
                    ...
                    <div class="dropdown-divider" role="presentation"><span class="filler">&nbsp;</span></div>
                                                                <a href="https://moodle.nottingham.ac.uk/login/logout.php?sesskey=E6ZdJYjIBP" class="dropdown-item menu-action" role="menuitem" data-title="logout,moodle" tabindex="-1" aria-labelledby="actionmenuaction-6">
...
<div class="row">
    ...
    <div class="col-md-4">        <div class="mdl-align">
            <div class="urlselect">
    <form method="post" action="https://moodle.nottingham.ac.uk/course/jumpto.php" class="form-inline" id="url_select_f637b8ff04388812">
        <input type="hidden" name="sesskey" value="E6ZdJYjIBP">
...
coursework) per module.<br></p></div>
  ...
  <span id="sb-4"></span></aside>
    ...
    <div
    id="drawer-637b8ff0520a7637b8ff04388813"
    ...
    tabindex="0"
>
            <div id="message-drawer-637b8ff0520a7637b8ff04388813" class="message-app" data-region="message-drawer" role="region">
            ...
            <div class="body-container position-relative" data-region="body-container">
                ...
                >
                ...
                </div>                <div class="hidden h-100" data-region="view-contacts" aria-hidden="true" data-user-id="311621">
                    <div class="d-flex flex-column h-100">
                        <div class="p-3 border-bottom">
                            <ul class="nav nav-pills nav-fill" role="tablist">
                                <li class="nav-item">
                                    <a
                                        id="contacts-tab-637b8ff0520a7637b8ff04388813"
                                        class="nav-link active"
                                        href="#contacts-tab-panel-637b8ff0520a7637b8ff04388813"
                                        data-toggle="tab"
                                        data-action="show-contacts-section"
                                        role="tab"
                                        aria-controls="contacts-tab-panel-637b8ff0520a7637b8ff04388813"
                                        aria-selected="true"
                                    >
                                        Contacts
                                    </a>
                                ...
                                <li class="nav-item">
                                    <a
                                        id="requests-tab-637b8ff0520a7637b8ff04388813"
                                        class="nav-link"
                                        href="#requests-tab-panel-637b8ff0520a7637b8ff04388813"
                                        data-toggle="tab"
                                        data-action="show-requests-section"
                                        role="tab"
                                        aria-controls="requests-tab-panel-637b8ff0520a7637b8ff04388813"
                                        aria-selected="false"
                                    >
                                        Requests
                                        <span class="badge badge-primary bg-primary ml-2 hidden"
                    ...
                    data-user-id="311621"
                                        id="contacts-tab-panel-637b8ff0520a7637b8ff04388813"
                    data-section="contacts"
                    role="tabpanel"
                    aria-labelledby="contacts-tab-637b8ff0520a7637b8ff04388813"
                ...
                >
                    ...
                    data-region="lazy-load-list"
                    data-user-id="311621"
                                        id="requests-tab-panel-637b8ff0520a7637b8ff04388813"
                    data-section="requests"
                    role="tabpanel"
                    aria-labelledby="requests-tab-637b8ff0520a7637b8ff04388813"
                ...
                >
                    <div
                        ...
                        style="overflow-y: auto"
                    ></div>
                </div>                <div class="h-100 view-overview-body" aria-hidden="false" data-region="view-overview"  data-user-id="311621">
                    <div id="message-drawer-view-overview-container-637b8ff0520a7637b8ff04388813" class="d-flex flex-column h-100" style="overflow-y: auto">
                            ...
                            >
                                <div id="view-overview-favourites-toggle" class="card-header" data-region="toggle">
                                    <button
                                        ...
                                        data-target="#view-overview-favourites-target-637b8ff0520a7637b8ff04388813"
                                        aria-expanded="false"
                                        aria-controls="view-overview-favourites-target-637b8ff0520a7637b8ff04388813"
                                    >
                                ...
                                data-region="lazy-load-list"
                                data-user-id="311621"
                                            id="view-overview-favourites-target-637b8ff0520a7637b8ff04388813"
            aria-labelledby="view-overview-favourites-toggle"
            data-parent="#message-drawer-view-overview-container-637b8ff0520a7637b8ff04388813"
                            ...
                            >
                                <div id="view-overview-group-messages-toggle" class="card-header" data-region="toggle">
                                    <button
                                        class="btn btn-link w-100 text-left p-1 p-sm-2 d-flex align-items-center overview-section-toggle collapsed"
                                        data-toggle="collapse"
                                        data-target="#view-overview-group-messages-target-637b8ff0520a7637b8ff04388813"
                                        aria-expanded="false"
                                        aria-controls="view-overview-group-messages-target-637b8ff0520a7637b8ff04388813"
                                    >
                                        <span class="collapsed-icon-container">
                                            <i class="icon fa fa-caret-right fa-fw " aria-hidden="true"  ></i>
                                        </span>
                                ...
                                data-region="lazy-load-list"
                                data-user-id="311621"
                                            id="view-overview-group-messages-target-637b8ff0520a7637b8ff04388813"
                            ...
                            >
                                <div id="view-overview-messages-toggle" class="card-header" data-region="toggle">
                                    <button
                                        class="btn btn-link w-100 text-left p-1 p-sm-2 d-flex align-items-center overview-section-toggle collapsed"
                                        data-toggle="collapse"
                                        data-target="#view-overview-messages-target-637b8ff0520a7637b8ff04388813"
                                        aria-expanded="false"
                                        aria-controls="view-overview-messages-target-637b8ff0520a7637b8ff04388813"
                                    >
                                        <span class="collapsed-icon-container">
                                            <i class="icon fa fa-caret-right fa-fw " aria-hidden="true"  ></i>
                                        </span>
                                ...
                                data-region="lazy-load-list"
                                data-user-id="311621"
                                            id="view-overview-messages-target-637b8ff0520a7637b8ff04388813"
                        ...
                        <div data-region="settings" class="p-3">
                                    ...
                                    <legend class="sr-only">Accept messages from:</legend>
                                        <div class="custom-control custom-radio mb-2">
                                            <input
                                                ...
                                                id="block-noncontacts-637b8ff0520a7637b8ff04388813-1"
                                                value="1"
                                            >
                                            <label class="custom-control-label ml-2" for="block-noncontacts-637b8ff0520a7637b8ff04388813-1">
                                                My contacts only
                                            </label>
                                        </div>
                                        <div class="custom-control custom-radio mb-2">
                                            <input
                                                ...
                                                name="message_blocknoncontacts"
                                                class="custom-control-input"
                                                id="block-noncontacts-637b8ff0520a7637b8ff04388813-0"
                                                value="0"
                                            >
                                            <label class="custom-control-label ml-2" for="block-noncontacts-637b8ff0520a7637b8ff04388813-0">
                            ...
                            <div data-preference="entertosend">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" class="custom-control-input" id="enter-to-send-637b8ff0520a7637b8ff04388813" >
                                    <label class="custom-control-label" for="enter-to-send-637b8ff0520a7637b8ff04388813">
                                        Use enter to send
                                    </label>
                                </div>
                            </div>
    ...
    >
        ...
        <div class="menubar d-flex " id="action-menu-3-menubar">
                ...
                <div class="action-menu-trigger">
                    ...
                    <div class="dropdown-divider" role="presentation"><span class="filler">&nbsp;</span></div>
                                                                <a href="https://moodle.nottingham.ac.uk/user/profile.php?id=311621" class="dropdown-item menu-action" role="menuitem" data-title="profile,moodle" tabindex="-1" aria-labelledby="actionmenuaction-8">
                                <i class="icon fa fa-user fa-fw " aria-hidden="true"  ></i>
                    ...
                    <div class="dropdown-divider" role="presentation"><span class="filler">&nbsp;</span></div>
                                                                <a href="https://moodle.nottingham.ac.uk/login/logout.php?sesskey=E6ZdJYjIBP" class="dropdown-item menu-action" role="menuitem" data-title="logout,moodle" tabindex="-1" aria-labelledby="actionmenuaction-12">
                                <i class="icon fa fa-sign-out fa-fw " aria-hidden="true"  ></i>
    ...
    <a class="dropdown-toggle nav-link" id="drop-down-637b8ff05a603637b8ff04388822" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="#"  aria-controls="drop-down-menu-637b8ff05a603637b8ff04388822">
        Library Search (NUSearch)
    </a>
    <div class="dropdown-menu" role="menu" id="drop-down-menu-637b8ff05a603637b8ff04388822" aria-labelledby="drop-down-637b8ff05a603637b8ff04388822">
    ...
    <a class="dropdown-toggle nav-link" id="drop-down-637b8ff05a687637b8ff04388823" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="#"  aria-controls="drop-down-menu-637b8ff05a687637b8ff04388823">
        Library Locations
    </a>
    <div class="dropdown-menu" role="menu" id="drop-down-menu-637b8ff05a687637b8ff04388823" aria-labelledby="drop-down-637b8ff05a687637b8ff04388823">
    ...
    <a class="dropdown-toggle nav-link" id="drop-down-637b8ff05a71d637b8ff04388824" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="#"  aria-controls="drop-down-menu-637b8ff05a71d637b8ff04388824">
        Studying Effectively
    </a>
    <div class="dropdown-menu" role="menu" id="drop-down-menu-637b8ff05a71d637b8ff04388824" aria-labelledby="drop-down-637b8ff05a71d637b8ff04388824">
    ...
    <a class="dropdown-toggle nav-link" id="drop-down-637b8ff05a7a2637b8ff04388825" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="#"  aria-controls="drop-down-menu-637b8ff05a7a2637b8ff04388825">
        Help
    </a>
    <div class="dropdown-menu" role="menu" id="drop-down-menu-637b8ff05a7a2637b8ff04388825" aria-labelledby="drop-down-637b8ff05a7a2637b8ff04388825">
...
function(
    ...
    var toggle = $('#message-drawer-toggle-637b8ff04e039637b8ff0438883');
    Popover.init(toggle);
});
;
        ...
        require(['jquery', 'core/custom_interaction_events'], function($, CustomEvents) {
            ...
            $('#jump-to-activity').on(CustomEvents.events.accessibleChange, function() {
                ...
                $('#url_select_f637b8ff04388812').submit();
            });
        });
    ;

require(['jquery', 'core_message/message_drawer'], function($, MessageDrawer) {
    var root = $('#message-drawer-637b8ff0520a7637b8ff04388813');
    MessageDrawer.init(root, '637b8ff0520a7637b8ff04388813', false);
});
;
...
M.util.help_popups.setup(Y);
 M.util.js_pending('random637b8ff04388826'); Y.on('domready', function() { M.util.js_complete("init");  M.util.js_complete('random637b8ff04388826'); });
})();
//]]>
</script>
...
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","licenseKey":"85d36fdef0","applicationID":"3213358","transactionName":"NlJTbBQEWksEAEFYXw8YZEoPSllXAUxHVEMOQkNbA0pCUQAUG0FYEQ==","queueTime":0,"applicationTime":362,"atts":"GhVEGlweSRRHAhcLSxxK","errorBeacon":"bam.nr-data.net","agent":""}</script></body>
</html>